-- ============================================================
-- country.sql
-- Hands-on 5: Populate country table with complete world data
-- Handbook: spring-data-jpa-handson.docx
-- Run in MySQL BEFORE starting the Spring Boot application.
-- ddl-auto=validate requires table to already exist.
-- ============================================================
...
-- Insert all world countries (as specified in Hands-on 5)
